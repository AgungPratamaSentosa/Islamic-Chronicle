...
public class web extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Landscape = (Button) findViewById (R.id.setBtn2);
        Portrait = (Button) findViewById (R.id.setBtn3);
        ...
        view.loadUrl("https://drive.google.com/file/d/1LHQtBxyKz-nXY_i8b8Q5uXohxpnOKcoI/preview");
        registerForContextMenu(view);
        view.getSettings().setBuiltInZoomControls(true);
        view.getSettings().setDisplayZoomControls(false);
        view.setWebChromeClient(new web.MyChrome());
